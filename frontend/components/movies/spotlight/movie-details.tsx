...
export function MovieDetails({ movie, reviews = [] }: MovieDetailsProps) {
    ...
    const collectionPoster = tmdbImg(collection?.poster_path, 'w342');
                ...
                {collection && (
                    <Section title='Part of a Collection'>
                        <div className='group relative block  overflow-hidden rounded-xl border border-white/10'>
                            <div
                                className='relative min-h-40 w-full bg-muted'
                                // style={{
                                //     backgroundImage: collectionBackdrop
                                //         ? `url(${collectionBackdrop})`
                                //         : undefined,
